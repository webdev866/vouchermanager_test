        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.roomsType.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.rooms-types.update", [$roomsType->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('room_type') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="room_type" id="room_type" value="{{ old('room_type', $roomsType->room_type) }}" required>
