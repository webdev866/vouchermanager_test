            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-roomTypeCreateVouchers">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.createVoucher.fields.client_name') }}
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                @foreach($createVouchers as $key => $createVoucher)
                                    <tr data-entry-id="{{ $createVoucher->id }}">
                                        ...
                                        <td>
                                            {{ $createVoucher->room_type->room_type ?? '' }}
                                        </td>
                                        <td>
...
@endcan
  ...
  let table = $('.datatable-roomTypeCreateVouchers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
