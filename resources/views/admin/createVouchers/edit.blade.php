                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.create-vouchers.update", [$createVoucher->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('client_name') ? 'has-error' : '' }}">
                            <label class="required" for="client_name">{{ trans('cruds.createVoucher.fields.client_name') }}</label>
                            <input class="form-control" type="text" name="client_name" id="client_name" value="{{ old('client_name', $createVoucher->client_name) }}" required>
                            @if($errors->has('client_name'))
                            <span class="help-block" role="alert">{{ $errors->first('client_name') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.createVoucher.fields.client_name_helper') }}</span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('room_type') ? 'has-error' : '' }}">
                            <label class="required" for="room_type_id">{{ trans('cruds.createVoucher.fields.room_type') }}</label>
                            <select class="form-control select2" name="room_type_id" id="room_type_id" required>
                                @foreach($room_types as $id => $entry)
                                <option value="{{ $id }}" {{ (old('room_type_id') ? old('room_type_id') : $createVoucher->room_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
