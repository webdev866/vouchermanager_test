        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @can('voucher_manager_access')
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
  @can('vouchers_accounting_access')
                    <li class="{{ request()->is("admin/vouchers-accountings") || request()->is("admin/vouchers-accountings/*") ? "active" : "" }}">
                        <a href="{{ route("admin.vouchers-accountings.index") }}">
                            <i class="fa-fw fas fa-cogs">

                            </i>
                            <span>{{ trans('cruds.vouchersAccounting.title') }}</span>

                        </a>
                    </li>
                    @endcan
        @can('arrivals_departure_access')
                            <li class="{{ request()->is("admin/arrivals-departures") || request()->is("admin/arrivals-departures/*") ? "active" : "" }}">
                                <a href="{{ route("admin.arrivals-departures.index") }}">
                                    <i class="fa-fw fas fa-cogs">

                                    </i>
                                    <span>{{ trans('cruds.arrivalsDeparture.title') }}</span>
                        ...
                        @endcan
                        @can('rooms_type_access')
                            <li class="{{ request()->is("admin/rooms-types") || request()->is("admin/rooms-types/*") ? "active" : "" }}">
                                <a href="{{ route("admin.rooms-types.index") }}">
                                    <i class="fa-fw fas fa-cogs">

                                    </i>
                                    <span>{{ trans('cruds.roomsType.title') }}</span>
