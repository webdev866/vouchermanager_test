...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Rooms Type
    Route::delete('rooms-types/destroy', 'RoomsTypeController@massDestroy')->name('rooms-types.massDestroy');
    Route::resource('rooms-types', 'RoomsTypeController');

    // Arrivals Departures
    Route::resource('arrivals-departures', 'ArrivalsDeparturesController');
